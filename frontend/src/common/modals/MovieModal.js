...
import {getMovie, changeRating} from "../../actions/movie";
            ...
            <div className="movie-details-content">
              <div style={{display: "flex", justifyContent: "space-between"}}>
                ...
                <div className="likes-wrapper">
                  <div className={"likes " + (movie.liked === 1 ? 'active' : '')} onClick={() => onLikeMovie(movie, 1)}>
                    {movie.likes} <ThumbUpIcon />
                  </div>
                  <div className={"likes " + (movie.liked === 0 ? 'active' : '')} onClick={() => onLikeMovie(movie, 0)}>
